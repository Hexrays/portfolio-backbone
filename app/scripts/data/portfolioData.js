...
app.siteData = [
    {
        ...
        responsibilities : 'My role was to work with the design team to style the site based on their vision. Sprite sheets were used for many of the UI assets. I was also responsible for implementing the Facebook Social Graph and FQL to allow users to select photos from their&nbspaccounts.',
        company          : 'Luxurious Animals',
        year             : '2014',
