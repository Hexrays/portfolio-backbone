...
app.siteData = [
    {
        ...
        className        : 'stripe',
        description      : 'Stripe Yourself is an app for the San Diego Zoo that allows users to upload their photos and decorate their face with tiger stripes, fur, eyes, ears, whiskers and change the background elements. It works across browsers, on phones, and on tablets.',
